...
distance_chart=newdata.plot.bar(x ='id' , y = 'total_distance' , rot = 0,title='distance for every player',xlabel='player id',ylabel='distance')
plt.savefig('average distance chart.jpg', transparent=True)
plt.show()