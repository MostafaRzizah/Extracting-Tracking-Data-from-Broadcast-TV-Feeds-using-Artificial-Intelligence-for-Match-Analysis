...
df= pd.read_csv('/outpot_data/calma_df_mapped_final.csv')
dfPlayers = pd.read_csv('/outpot_data/calma_df_mapped_final.csv')
...
direction = -1
fig, ax, dfFrame, polygons = draw_frame(df, dfPlayers, t=6)
dfFrame
